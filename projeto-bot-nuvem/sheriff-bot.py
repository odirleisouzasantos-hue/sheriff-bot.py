...
# 🛡️ Blacklist de domínios curingas/genéricos que respondem falso positivo
...
# 🛰️ MOTOR DE SINCRONIZAÇÃO HÍBRIDO (GITHUB + LOCAL)
...
async def baixar_lista_automatica(forçar=False):
    ...
    if LINK_LISTA_FIXA and "COLE_O_LINK" not in LINK_LISTA_FIXA:
        ...
        try:
            ...
            print(f"⚠️ Falha ao baixar lista remota do GitHub: {str(e)}")
...
async def processar_sheriff_hibrido(dados_entrada, user_id, context, chat_id):
    ...
    if is_link_completo:
        ...
        relatorio = [
            ...
            f"⚠️ Ordenados por menor latência de resposta.",
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "🛡️ **SHERIFF DETECTOR V15.5 SMART FILTER OPERANTE**\n\n"
